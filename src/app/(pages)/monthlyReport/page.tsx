          ...
          <div className="flex flex-col gap-6 px-5">
            ...
            {hasLowCsSample ? (
              ...
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_1.4fr]">
                {/* Left column: KPIs + sentiment by aspect */}
                <div className="flex flex-col gap-6">
                  <div className="grid grid-cols-2 gap-4">
                    {kpiCards.map((k) => (
                      ...
                      >
                        ...
                        <p className="pt-1 text-3xl font-black">
                          <span className={k.tone === "highlight" ? "text-white" : "text-slate-900"}>
                            {k.value}
                          </span>{" "}
                          <span
                            className={
                              "text-sm font-bold uppercase " +
                              (k.tone === "highlight" ? "text-indigo-200" : "text-slate-500")
                            }
                          >
                            {k.unit}
                          </span>
                        ...
                        <p
                          className={
                            ...
                            (k.tone === "highlight" ? "text-indigo-100" : "text-emerald-600")
                          }
                        >
                          {k.trend}
                        </p>
                  ...
                  <div className="flex flex-col gap-5">
                    <div className="flex items-center justify-between">
                      <h2 className="text-lg font-black text-slate-900">항목별 고객 감성 분포</h2>
                      <div className="flex items-center gap-2 text-[11px] font-bold text-slate-500">
                        <span className="flex items-center gap-1.5">
                          <span className="h-2.5 w-2.5 rounded-full bg-emerald-500" />긍정
                        </span>
                        <span className="flex items-center gap-1.5">
                          <span className="h-2.5 w-2.5 rounded-full bg-slate-200" />중립
                        </span>
                        <span className="flex items-center gap-1.5">
                          <span className="h-2.5 w-2.5 rounded-full bg-rose-600" />부정
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                      {aspectCards.map((a) => (
                        <div
                          key={a.name}
                          className="flex flex-col gap-2 rounded-3xl border border-slate-100 bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.1),0_1px_2px_-1px_rgba(0,0,0,0.1)]"
                        >
                ...
                {/* Right column: channel reputation gap analysis (all pairs stacked) */}
                <div className="rounded-[32px] border border-slate-100 bg-white p-8 shadow-[0_20px_25px_-5px_rgba(243,244,246,0.5),0_8px_10px_-6px_rgba(243,244,246,0.5)]">
                  <div className="flex items-start justify-between pb-6">
                    <div>
                      <h2 className="text-xl font-black text-slate-900">채널 간 평판 격차 분석</h2>
                      <p className="pt-1 text-sm text-slate-500">채널 간 평판 차이</p>
                    </div>
                  ...
                  <div className="flex flex-col gap-10">
                    {gapSlides.map((s) => (
                      <div key={s.pair} className="flex flex-col gap-4">
                        <p className="text-base font-black text-slate-900">{s.pair}</p>
                        ...
                        <div>
                          ...
                          <div className="relative h-16 overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-500 via-amber-500 to-red-500">
                            <div
